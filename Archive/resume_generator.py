...
def _expand_plan(
    ...
    if initial_measure is None:
        pages, current_text = _compile_plan(current, job, template_text, output_dir, compiler)
    else:
    ...
    def run_phase(skills_only: bool) -> bool:
        ...
        while True:
            ...
            for candidate in _expansion_candidates(current, profile, job):
                ...
                attempted.add(key)
                pages, candidate_text = _compile_plan(candidate, job, template_text, output_dir, compiler)
...
def generate_resume(
    ...
    *,
    ...
    if advisory_requested:
        from .resume_advisor import request_resume_advice
