  ...
  const defaultActions = [
    {
      ...
      decision: {
        ...
        evidenceReferences: ['profile_verified:first_name'],
    ...
    actions: [
      {
        ...
        decision: {
          ...
          answerSource: 'profile_verified',
          evidenceReferences: ['profile_verified:country'],
          inferenceRationaleDigest: null,
          inferenceEvidenceDigests: null,
    ...
    actions: [
      {
        ...
        decision: {
          ...
          answerSource: 'profile_verified',
          evidenceReferences: ['profile_verified:ssn'],
          inferenceRationaleDigest: null,
          inferenceEvidenceDigests: null,
          proposedAction: 'fill_text',
    ...
    actions: [
      ...
      },
      {
        ...
        decision: {
          ...
          proposedAnswer: 'Doe',
          answerSource: 'profile_verified',
          evidenceReferences: ['profile_verified:last_name'],
          inferenceRationaleDigest: null,
          inferenceEvidenceDigests: null,
          proposedAction: 'fill_text',
      ...
      },
      {
        ...
        decision: {
          ...
          answerSource: 'profile_verified',
          evidenceReferences: ['profile_verified:email'],
          inferenceRationaleDigest: null,
          inferenceEvidenceDigests: null,
          proposedAction: 'fill_text',
