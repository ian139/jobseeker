...
import jobs_assistant.resume_generator as resume_module
import jobs_assistant.resume_generator_command as resume_command
from jobs_assistant.db import SCHEMA_SQL
from jobs_assistant.resume_generator import ResumeJob, generate_resume, load_resume_profile, optimize_resume
...
def test_shipped_profile_and_template_generate_with_fixture_compiler(tmp_path: Path) -> None:
    ...
    profile_path = repository / "resume" / "generator" / "profile.json"
    template_path = repository / "resume" / "generator" / "Resume.tex"
    skill_path = repository / "resume" / "generator" / "SKILL.md"
